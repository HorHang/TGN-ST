...
class Evaluator(object):
    ...
    def _eval_hits_and_mrr(self, y_pred_pos, y_pred_neg, type_info, k_value):
        ...
        if type_info == 'torch':
            ...
            #     print(
            #         f'y_pred_pos: {y_pred_pos},'
            #         f'y_pred_neg: {y_pred_neg},'
            #         f'optimistic_rank: {optimistic_rank},'
            #         f'pessimistic_rank: {pessimistic_rank},'
            #         f'ranking_list, {ranking_list},'
            #         f'hitsK_list: {hitsK_list},'
            #         f'mrr_list: {mrr_list}'
            #         )
