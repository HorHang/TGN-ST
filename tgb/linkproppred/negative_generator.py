...
class NegativeEdgeGenerator(object):
    def __init__(
        ...
        negative edges are sampled with 'one_vs_many' strategy.
        ...
        Parameters:
            ...
            last_dst_id: identity of the last destination node
            ...
            hist_ratio: if the strategy is 'hist_rnd', how much of the negatives are historical
    ...
    def generate_historical_edge_set(self, 
        ...
        r"""
        Generate the set of edges seen during training or validation
    ...
    def generate_negative_samples_hist_rnd(
        ...
        if os.path.exists(filename):
            ...
            # print(f'first 10 positive edge {pos_src[:10]}, {pos_dst[:10]}, {pos_timestamp[:10]}')
            ...
            for (
                ...
                # if test_idx < 10:
                #     test_idx += 1
                #     print(f"print top 10 pos_ts_edge_dict: {pos_ts_edge_dict}, {pos_s}, {pos_d}, {pos_t}")
            # all possible destinations
            all_dst = np.arange(self.first_dst_id, self.last_dst_id + 1)
            ...
            for (
                ...
                # if test_idx < 10:
                #     test_idx +=1
                #     print(f'print top 10 {pos_s}, {pos_d}, {pos_t}, {evaluation_set}')
