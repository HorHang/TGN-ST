...
def degree_over_time(graph: object,
    ...
    plot_for_snapshots(ave_degree, date_ls, title= title, y_title= "Average degree", filename=filepath+filename, 
...
def nodes_over_time(graph: object,  
    ...
    plot_for_snapshots(active_nodes, date_ls, title= title, y_title="Number of nodes", filename=filepath+filename, 
                       fig_size=fig_size, font_size=font_size, ticks_font_size=ticks_font_size)
    return 
...
def edges_over_time(graph: object, 
    ...
    plot_for_snapshots(active_edges, date_ls, title= title, y_title="Number of edges", filename=filepath+filename, 
                       fig_size=fig_size, font_size=font_size, ticks_font_size=ticks_font_size)
    return 
...
def nodes_and_edges_over_time(graph: object, 
    ...
    return plot_nodes_edges_per_ts(edges, nodes, date_ls, ts, title= title, filename=filepath+filename, 
                                   fig_size=fig_size, font_size=font_size, ticks_font_size=ticks_font_size)
...
def degree_density(graph: tuple,
    ...
    plot_density_map(degrees_by_k_list, date_ls, y_title="Node Degree", filename = plot_path + filename, 
                     fig_size=fig_size, font_size=font_size, ticks_font_size=ticks_font_size)
    return 
...
def connected_components_per_ts(graph: tuple,
    ...
    plot_for_snapshots(num_components, date_ls, title = title, y_title="Number of connected components", filename=plot_path+filename, 
                       fig_size=fig_size, font_size=font_size, ticks_font_size=ticks_font_size)
    return 
