...
from models.module import TimeEncoder, MergeLayer, MultiHeadAttention
...
class GraphAttentionEmbedding(nn.Module):
    ...
    def __init__(self, node_raw_features: torch.Tensor, edge_raw_features: torch.Tensor, neighbor_sampler: NeighborSampler,
        ...
        print("self.edge_feat_dim", self.edge_feat_dim)
        print("self.time_feat_dim", self.time_feat_dim)
    ...
    def compute_node_temporal_embeddings(self, node_memories: torch.Tensor, node_ids: np.ndarray, node_interact_times: np.ndarray,
        ...
        if current_layer_num == 0:
            ...
            print("node_conv_features", node_conv_features.shape)
            print("node_time_features", node_time_features.shape)
            print("neighbor_node_conv_features", neighbor_node_conv_features.shape)
            print("neighbor_time_features", neighbor_time_features.shape)
            print("neighbor_edge_features", neighbor_edge_features.shape)
            print("neighbor_node_ids", neighbor_node_ids.shape)
